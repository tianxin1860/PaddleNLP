...
if __name__=="__main__":
    ...
    for line in sys.stdin:
        ...
        epoch, dev_acc, dev_num = line.strip().split(",")
        ...
        print("{}\t{}\t{}\t{}".format(strategy, epoch, dev_acc, dev_num), file=sys.stderr)
    ...
    print("{}\t{}\t{}\t{}".format(strategy, epoch, max_dev_acc, dev_num), file=sys.stderr)
